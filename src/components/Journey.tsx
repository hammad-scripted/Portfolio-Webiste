              ...
              >
                ...
                <div className="absolute left-4 top-1 z-10 -translate-x-1/2 md:left-1/2">
                  <motion.span
                    ...
                    className="grid h-9 w-9 place-items-center rounded-full border-4 border-cream bg-brand-700 text-gold-300 shadow-lg dark:border-night dark:bg-gold-500 dark:text-night"
                  >
                ...
                <motion.div
                  ...
                  className={`ml-12 w-full rounded-2xl border border-brand-200/70 bg-ivory p-6 shadow-sm md:ml-0 md:w-[calc(50%-2.5rem)] dark:border-brand-800 dark:bg-ink-soft ${
                    left ? "md:mr-auto md:text-right" : "md:ml-auto"
                  }`}
                >
                  <span className="font-serif text-2xl font-light italic text-gold-600 dark:text-gold-300">
                    {t.year}
                  </span>
                  <h3 className="mt-2 font-serif text-xl font-normal text-brand-950 dark:text-ivory">
                    {t.title}
                  </h3>
